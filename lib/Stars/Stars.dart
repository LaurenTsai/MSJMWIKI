...
class Starss extends StatefulWidget {
  @override
  _StarssState createState() => _StarssState();
}

class _StarssState extends State<Starss> {
    ...
    return Scaffold(
        ...
        body: Column(
            ...
            children: <Widget>[
              ...
              SizedBox(height: 10),
              Image.network(
                'https://upload.wikimedia.org/wikipedia/commons/thumb/6/62/Starsinthesky.jpg/228px-Starsinthesky.jpg',
                fit: BoxFit.cover,
                height: 150,
